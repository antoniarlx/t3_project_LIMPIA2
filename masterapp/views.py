...
def movie_info(request, id):
    ...
    template = loader.get_template('masterapp/movie_info.html')
...
def characters(request, id):
    ...
    template = loader.get_template('masterapp/characters.html')
...
def starships(request, id):
    ...
    template = loader.get_template('masterapp/starships.html')
...
def planets(request, id):
    ...
    template = loader.get_template('masterapp/planets.html')
